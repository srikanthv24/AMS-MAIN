...
class BrowseFotoPDF extends React.Component {
    constructor(props) {
        super(props);
    ...
    async fileSelected() {
        ...
        if (!(/\.(jpg|jpeg|png|pdf)$/i).test(filename)) {
            ...
            newFormObj.errMsg = "Only .jpg, .jpeg, .png & .pdf files are allowed"
        }
...
export default connect(mapStateToProps, mapDispatchToProps, null, { forwardRef: true })(BrowseFotoPDF);