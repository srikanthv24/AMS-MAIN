...
class ReportArmadaBongkarPerHari extends React.Component {
    ...
    render() {
        let { Data, NumberOfRecords } = this.props.reportArmadaBongkarPerHari,
                                        ...
                                        <div className="row">
                                            <div className="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                                <div className="chart">
                                                    ...
                                                    <BarChart width={900} height={350} data={LoadUnloacOrdersByDates} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
